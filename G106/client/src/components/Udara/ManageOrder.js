              ...
              <TableHead>
                <TableRow>
                  <TableCell align="center" className="ud_order_cellColor">
                    <div className="ud_order_headcolor">Sup_NAME</div>
                  </TableCell>
                  <TableCell align="center" className="ud_order_cellColor">
                    <div className="ud_order_headcolor">Com_Name</div>
                  </TableCell>
                  <TableCell align="center" className="ud_order_cellColor">
                    <div className="ud_order_headcolor">Prod_Name</div>
                  </TableCell>
                  <TableCell align="center" className="ud_order_cellColor">
                    <div className="ud_order_headcolor">Quantity</div>
                  </TableCell>
                  <TableCell align="center" className="ud_order_cellColor">
                    <div className="ud_order_headcolor">Tot_Price</div>
                  </TableCell>
                  <TableCell align="center" className="ud_order_cellColor">
